...
Interpolatie wordt bewust niet opgelost: ${APP_URL}/api gaat letterlijk de kluis in. Een bare naam zonder = telt als lege waarde; een dubbele sleutel houdt de laatste waarde, zoals het laden van het bestand zou doen.
