    ...
    return (
        <div className="space-y-6">
            <Heading
                ...
                description="How long a value may stand before Envserver calls it out. It never changes a secret by itself — it only tells you which ones have been sitting still."
            />
