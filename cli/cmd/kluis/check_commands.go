...
const (
	...
	// for the same reason "kluis pull" never prunes without being asked: a
...
// describeDrifts renders the differences the way "kluis diff" renders them.
...
func checkCommand() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: "Reads the latest release and compares it with your file, like \"kluis\n" +
	...
	cmd.Flags().StringVarP(&file, "file", "f", "", "the file to check (default: .env next to kluis.json)")
