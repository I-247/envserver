...
const ProjectFileName = "kluis.json"
...
// ErrNoProject is returned when no kluis.json can be found.
var ErrNoProject = errors.New("no kluis.json found; run \"kluis init\" in your project")

// FindProject walks up from dir looking for a kluis.json, the way git finds
...
func CredentialsPath() (string, error) {
	if override := os.Getenv("KLUIS_CONFIG_DIR"); override != "" {
	...
	return filepath.Join(dir, "kluis", "credentials.json"), nil
}
